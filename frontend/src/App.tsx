...
import { KITCHEN_BOARD_PERMISSION, PRODUCTS_MANAGE_PERMISSION } from './auth/permissions'
    ...
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        <Route element={<RequireRole permission={KITCHEN_BOARD_PERMISSION} />}>
          ...
          <Route element={<RequireRole permission={PRODUCTS_MANAGE_PERMISSION} />}>
            <Route path="staff/products" element={<StaffProductsScreen />} />
            <Route path="staff/products/new" element={<StaffProductEditScreen />} />
            <Route path="staff/products/:productId" element={<StaffProductEditScreen />} />
          </Route>
